package net.corda.samples.corda
...
import net.corda.samples.corda.JsonFailure.InvalidCryptoSuiteFailure
import net.corda.samples.corda.JsonFailure.InvalidEncoding
import net.corda.samples.corda.JsonFailure.InvalidUriFailure
import net.corda.samples.corda.JsonFailure.MissingPropertyFailure
import net.corda.core.crypto.AddressFormatException
import net.corda.core.crypto.Base58
import net.corda.samples.corda.did.CryptoSuite
import net.corda.samples.corda.did.PublicKeyEncoding
import net.corda.samples.corda.did.SignatureEncoding
...
//			}
		...
		Failure(JsonFailure.InvalidEncodingBase58(value))
	} catch (e: DecoderException) {
		Failure(JsonFailure.InvalidEncodingHex(value))
	} catch (e: IllegalArgumentException) {
		Failure(InvalidEncoding(value))
	} catch (e: IllegalStateException) {
		Failure(JsonFailure.InvalidEncodingMultiBase(value))
	} catch (e: Exception) {
		Failure(InvalidEncoding(value))
	}
}
