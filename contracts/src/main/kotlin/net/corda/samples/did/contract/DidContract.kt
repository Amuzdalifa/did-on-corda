package net.corda.samples.did.contract

import com.natpryce.Success
import com.natpryce.map
import com.natpryce.onFailure
import net.corda.samples.did.contract.DidContract.Commands
import net.corda.samples.did.contract.DidContract.Commands.Create
import net.corda.samples.did.contract.DidContract.Commands.Delete
import net.corda.samples.did.contract.DidContract.Commands.Update
import net.corda.samples.did.contract.DidContract.Companion.DID_CONTRACT_ID
...
open class DidContract : Contract {
	...
	companion object {
		 ...
		 */
		@JvmStatic
		val DID_CONTRACT_ID = "net.corda.samples.did.contract.DidContract"
	}
